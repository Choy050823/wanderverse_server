        ...
        if (i == 0) {
            ...
            if (startLocationDetails != null && startLocationDetails.getPlaceId() != null) {
                ...
                if (startLocationDetails != null && startLocationDetails.getPlaceId() != null) {
                    ...
                    // IMPORTANT: If this returns null, the prompt will receive "null" as the start location,
                    // which is likely not a valid place_id string and can cause issues.
                    // Consider returning a default known place_id or throwing an exception.
                    return null; // This will result in "null" in the prompt string.
                }
            }
        } else {
            DailyItineraryDTO previousDayItinerary = dailyItineraryList.get(i - 1);
